...
### Install a Gem in specific version
  ...
  gem install j1-template -v 2023.2.0 --user-install --no-document
...
### Install a Gem from different source
  ...
  gem install j1-template -v 2023.2.0 --source 'https://gem.fury.io/jekyll-one-org/' --user-install --no-document
