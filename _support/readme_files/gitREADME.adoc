...
#
  git tag -a "v2023.1.0" -m "v2023.1.0"
...
Then:
  ...
  git commit -am "New version v2023.1.0"
  git commit --allow-empty -m "New version v2023.1.0"
  git commit -am "Prepare new version v2023.1.0"
  git commit -am "Latest files of version v2023.1.0"
