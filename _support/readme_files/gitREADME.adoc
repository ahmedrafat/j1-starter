...
#
  git tag -a "v2023.2.3" -m "v2023.2.3"
...
Then:
  ...
  git commit -am "New version v2023.2.3"
  git commit --allow-empty -m "New version v2023.2.3"
  git commit -am "Prepare new version v2023.2.3"
  git commit -am "Latest files of version v2023.2.3"
